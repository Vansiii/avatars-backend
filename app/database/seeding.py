...
initial_styles = [
    # Categoría: Profesional
    {
        ...
        "base_prompt": "Professional corporate portrait, neutral studio background, business attire, high quality, realistic lighting",
        "tier_required": "free",
    ...
    },
    {
        ...
        "base_prompt": "Creative professional portrait, modern art studio background, smart casual, warm colors, natural expression",
        "tier_required": "free",
    ...
    },
    {
        ...
        "example_urls": [],
        "base_prompt": "Executive headshot, dark gradient background, formal suit, sharp focus, cinematic lighting, 8k resolution",
        "tier_required": "free",
    ...
    # Categoría: Gaming / Streamer
    {
        ...
        "example_urls": [],
        "base_prompt": "Cyberpunk gamer avatar, neon pink and blue lighting, futuristic headphones, dark gaming room background",
        "tier_required": "free",
    ...
    },
    {
        ...
        "example_urls": [],
        "base_prompt": "Japanese anime style avatar, vibrant cel-shaded coloring, cute features, gaming background, digital art",
        "tier_required": "free",
    ...
    },
    {
        ...
        "example_urls": [],
        "base_prompt": "16-bit retro pixel art portrait, video game style, colorful background, pixelated details",
        "tier_required": "free",
    ...
    },
    {
        ...
        "example_urls": [],
        "base_prompt": "Western 3D cartoon style avatar, Disney Pixar style, exaggerated expressions, bright solid background",
        "tier_required": "free",
    ...
    # Categoría: Redes Sociales
    {
        ...
        "example_urls": [],
        "base_prompt": "Pop art portrait, dynamic colorful gradient background, high contrast, trendy social media profile",
        "tier_required": "free",
    ...
    },
    {
        ...
        "example_urls": [],
        "base_prompt": "Minimalist high contrast portrait, clean lines, black and white aesthetic, solid white background, elegant",
        "tier_required": "free",
    ...
    },
    {
        ...
        "example_urls": [],
        "base_prompt": "Sticker art portrait, thick white outline, cartoon graphic design, flat colors, transparent look background",
        "tier_required": "free",
    ...
    # Categoría: Videojuegos (Pro)
    {
        ...
        "example_urls": [],
        "base_prompt": "RPG fantasy hero portrait, wearing detailed plate armor, glowing sword reflections, epic medieval background",
        "tier_required": "pro",
    ...
    },
    {
        ...
        "example_urls": [],
        "base_prompt": "Sci-Fi space marine avatar, high-tech powered armor, visor glowing, alien planet sky background, digital art",
        "tier_required": "pro",
    ...
    },
    {
        ...
        "example_urls": [],
        "base_prompt": "Dark fantasy warrior, gothic architecture, misty ruins background, eerie dramatic lighting, detailed armor",
        "tier_required": "pro",
